...
| CSLC | NAM | *2/2 CALIBRATING — binds v1.2 \| coh=0.80 / resid=1.1 mm/yr (Mojave)* | *amp_r=0.98 / amp_rmse=1.3 dB* |
| CSLC | EU | *1/1 CALIBRATING — binds v1.2 \| coh=0.87 / resid=0.0 mm/yr (Iberian)* | *amp_r=0.00 / amp_rmse=0.0 dB* |
