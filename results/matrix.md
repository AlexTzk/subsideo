...
| DISP | NAM | *coh=0.00 ([fresh]) / resid=-0.0 mm/yr / attr=inconclusive / era5=on / signals=0 / cand=spurt:BLOCKER,deramp:BLOCKER* (CALIBRATING — needs 3rd AOI before binding; see DISP_UNWRAPPER_SELECTION_BRIEF.md)* | 0.007134 (> 0.92 FAIL) / 55.43 (< 3 FAIL) |
| DISP | EU | *coh=0.00 ([fresh]) / resid=+0.1 mm/yr / attr=inconclusive / era5=on / signals=0 / cand=spurt:BLOCKER,deramp:BLOCKER* (CALIBRATING — needs 3rd AOI before binding; see DISP_UNWRAPPER_SELECTION_BRIEF.md)* | 0.3358 (> 0.92 FAIL) / 3.461 (< 3 FAIL) |
