...
Phase 10 ERA5-on diagnostics did not promote ERA5 into a required Phase 11 baseline. Bologna reference-agreement was effectively unchanged from the v1.1 baseline (r=0.3358 both runs; bias=+3.46 mm/yr both runs; ramp attribution remained `inconclusive`). ERA5 is retained as a diagnostic option for Phase 12 only.
