...
- [x] 06-05-PLAN.md — N.Am. positive control: run_eval_dswx_nam.py NEW (10-stage CANDIDATES iteration + INVESTIGATION_TRIGGER halt) + execute eval + CONCLUSIONS_DSWX_N_AM.md NEW + USER CHECKPOINT [Wave 3] [DSWX-01] — F1=0.9252 PASS (Lake Tahoe T10SFH); EU recalibration cleared; checkpoint pending user approval
